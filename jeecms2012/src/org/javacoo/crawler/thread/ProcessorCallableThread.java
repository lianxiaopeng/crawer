package org.javacoo.crawler.thread;
...
import org.javacoo.crawler.processor.Processor;
/**
 * 处理线程-从边界控制器获取任务并执行
 * <li>把任务交给任务处理链处理</li>
 * @author javacoo
...
public class ProcessorCallableThread implements Callable<Task> {
	...
	public ProcessorCallableThread(CrawlController controller,CountDownLatch latch,Task task) {
