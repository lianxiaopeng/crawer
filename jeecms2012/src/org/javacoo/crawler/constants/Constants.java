package org.javacoo.crawler.constants;
...
public abstract class Constants {
	...
	public final static String REPLACE_NAME = CrawlerConfig.replaceName;
	/**资源保存根路径*/
	...
	public final static List<Map<String,Integer>> PROXY_SERVER_LIST = CrawlerConfig.proxyServerList;
	/**默认替换后字符*/
	public final static String DEFAULT_WORDS = CrawlerConfig.defaultWords;
	/**默认全局替换字符,格式:待替换字符1=替换后字符1,待替换字符2=替换后字符2,待替换字符3,待替换字符4...*/
	public final static Map<String,String> DEFAULT_COMMON_REPLACE_WORDS = CrawlerConfig.defaultCommonReplaceWords;
