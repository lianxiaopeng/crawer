...
public abstract class BaseHistory  implements Serializable {
	 ...
	 */
	public BaseHistory (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	// many to one
	private org.javacoo.expand.jeecms.entity.Rule rule;
	...
	public org.javacoo.expand.jeecms.entity.Rule getRule() {
		return rule;
	}

	public void setRule(org.javacoo.expand.jeecms.entity.Rule rule) {
		this.rule = rule;
	}
