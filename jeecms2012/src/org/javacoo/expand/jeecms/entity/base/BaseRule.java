...
public abstract class BaseRule  implements Serializable {
	...
	public static String PROP_PAGINATION_REPIRE_URL = "paginationRepairUrl";
	...
	public static String PROP_REPLACE_WORDS = "replaceWords";
	 ...
	 */
	public BaseRule (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	private java.lang.String useProxy;
	...
	private org.javacoo.expand.jeecms.entity.CommonType type;
	...
	public void setUseProxy(java.lang.String useProxy) {
	 ...
	 */
	public org.javacoo.expand.jeecms.entity.CommonType getType () {
		return type;
	}
	 ...
	 */
	public void setType (org.javacoo.expand.jeecms.entity.CommonType type) {
		this.type = type;
	}
